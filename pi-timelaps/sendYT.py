...
def get_authenticated_service():
  ...
  #credentials = "4/AACEdd9FCuw-UBDIChtZJP5j9fbj7dxRIxATK_m8RchLYurDnP-YSQE"
...
if __name__ == '__main__':
  ...
  media_file = '/media/sda/timelaps/GMTimelaps/cloudGM_192_mardi.mp4'
  ...
  videos_insert(client, 
    {'snippet.categoryId': '22',
     ...
     'snippet.description': 'Cloudy timelaps by guillaume.',
     'snippet.tags[]': '',
     'snippet.title': 'Cloudy timelaps by guillaume',
     'status.embeddable': '',
     'status.license': '',
